...
## url 規則（非常重要）
sources 中的 url 必須是直接連到該商品或該筆拍賣的完整頁面 URL，不能是首頁或搜尋結果頁。
- ✅ https://shopee.tw/product/123456/789012
- ✅ https://www.decathlon.com.tw/zh/p/folding-chair-123.html
- ❌ https://shopee.tw（首頁）
- ❌ https://www.decathlon.com.tw（首頁）
- ❌ https://shopee.tw/search?keyword=xxx（搜尋頁）
如果找到的來源沒有具體商品 URL，請不要列入 sources。

## 回傳格式（嚴格 JSON，不要 markdown）
{
  "newPrice": 數字或null,
  "sources": [
    {"title": "來源名稱", "url": "https://直接商品頁URL", "price": 數字, "type": "new或secondhand"}
  ],
  "suggestedPrice": 數字,
  "priceRangeLow": 數字,
  "priceRangeHigh": 數字,
